...
<section id="container" >
        ...
        <section class="wrapper">
            ...
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <section class="panel">
                        <div class="panel-body">
                            <a href="https://github.com/OliangchenO/" target="_blank" class="task-thumb">
                                <img width="83px" height="83px" src="lib/flatlab/img/avatar.jpg" alt="">
                            </a>
                            <div class="task-thumb-details">
                                <h1><a href="https://github.com/OliangchenO/" target="_blank">OliangchenO</a></h1>
                                <p>Author</p>
                            </div>
                        </div>
                        <table class="table table-hover personal-task">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a target="_blank" href="https://github.com/OliangchenO/">
                                        个人简介
                                    </a>
                                    <a target="_blank" href="https://github.com/OliangchenO/">
                                        个人博客
                            ...
                            <tr>
                                ...
                                <td>
                                    <a target="_blank" href="http://music.163.com/#/user/home?id=406042303">
                                        网易云音乐
                                    </a>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="mailto:593705862@qq.com" target="_blank">593705862@qq.com</a>
                                </td>
                            ...
                            <div class="post-info">
                                ...
                                <div class="panel-body">
                                    ...
                                    <footer class="social-footer">
                                        <ul>
                                            <li>
                                                <a href="https://github.com/OliangchenO" target="_blank">
                                            ...
                                            <li>
                                                <a href="http://blog.OliangchenO.cn/" target="_blank">
    ...
    <footer class="site-footer">
        <div class="text-center">
            Copyright &copy;2018 <a href="http://blog.OliangchenO.cn" target="_blank">OliangchenO.cn</a> All Rights Reserved.
...
<script>
    ...
    window.changyan.api.config({
        appid: 'cytvujRkj',
        conf: 'prod_6d96a6c729576c0965dd8f1d84d50b8f'
    });
