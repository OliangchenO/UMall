...
<div data-vide-bg="lib/video/Ipad">
    <div class="center-container">
        ...
        <div class="header-w3l">
            <h1>UMall<span class="title">后台管理系统</span></h1>
        </div>
        <!--//header-->
        ...
        <!--footer-->
        <div class="footer">
            <p>&copy; 2017 UMall. All rights reserved | Design by <a href="http://blog.exrick.cn" target="_blank">Exrick</a></p>
        </div>
        <!--//footer-->
    </div>
</div>
